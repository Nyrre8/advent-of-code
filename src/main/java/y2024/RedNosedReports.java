...
public class RedNosedReports {
    ...
    public RedNosedReports() {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader("y2024/inputrednosedreports.txt"))) {
            String line;
            ...
            System.out.println(amountOfSafeReportsDampener+amountOfSafeReports);
